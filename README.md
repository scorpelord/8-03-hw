...
<img width="2534" height="532" alt="image" src="https://github.com/user-attachments/assets/40742d9f-d53a-4fa2-bcd6-390073e2648a" />

### Веб-страница с картинкой

Уже несколько часов пытался сделать и через консоль, и через web версию, но user-data не применяется, во вложении приложил yaml. Cloud-init иногда не применяет user-data при создании из готового образа LAMP.
